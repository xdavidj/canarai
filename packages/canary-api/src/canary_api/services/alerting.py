...
async def dispatch_webhook(
    ...
    headers = {
        ...
        "X-Canary-Event": event_type,
        "X-Canary-Delivery": delivery.id,
    }
...
async def send_test_webhook(
    ...
    test_payload = {
        ...
        "data": {
            "message": "This is a test webhook delivery from Canary API.",
        },
    }
    ...
    headers = {
        "Content-Type": "application/json",
        "X-Canary-Signature": signature,
        "X-Canary-Event": "webhook.test",
        "X-Canary-Delivery": str(uuid.uuid4()),
    }
