...
from canary_api.db.engine import dispose_engine, init_db
from canary_api.routers import config, feed, health, ingest, results, sites, webhooks
...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Canary API v%s in %s mode", __version__, settings.environment)
    ...
    logger.info("Canary API shut down")
