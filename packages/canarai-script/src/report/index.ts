...
import type { CanaraiConfig, IngestPayload } from '../types';
...
function sendPayload(
  ...
  preferredMode: CanaraiConfig['reportingMode'],
 ...
 */
export function createReporter(config: CanaraiConfig, fetchFn?: typeof window.fetch) {
